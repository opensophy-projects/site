		...
		{#if hasMenuActions}
			<div class="relative rounded-xl bg-background-inset p-1.5 inset-shadow">
				<button
					...
					class="card relative inline-flex size-9 items-center justify-center rounded-lg border border-border bg-background text-foreground transition-[background-color,transform] duration-150 ease-out hover:-translate-y-0.5 hover:border-accent/60 disabled:pointer-events-none disabled:opacity-50"
