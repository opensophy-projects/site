<script lang="ts">
	...
	const buttonClass =
		"inset-shadow card relative inline-flex size-9 items-center justify-center rounded-sm border border-border bg-background-inset text-foreground transition-[background-color] duration-150 ease-out hover:bg-background-muted disabled:pointer-events-none disabled:opacity-50";
</script>
	...
	<div class="relative z-20 mt-8 flex w-full gap-2 lg:hidden">
		{#if canShowCopy}
			<button
				...
				class="inset-shadow card relative inline-flex h-9 flex-1 items-center justify-center gap-2 rounded-sm border border-border bg-background-inset px-3 text-sm font-medium tracking-normal text-foreground transition-[background-color] duration-150 ease-out hover:bg-background-muted disabled:pointer-events-none disabled:opacity-50"
			>
