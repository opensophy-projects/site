...
<section class="services-grid">
  ...
  <div class="card-shell card-security-analysis">
    <div class="card-inner">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">
          Выстраиваю DevSecOps под ключ: автоматические проверки кода и зависимостей, безопасные пайплайны и понятные правила для команды.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card-shell card-automation">
    <div class="card-inner">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">
          Нахожу и исправляю неполадки Docker, Linux-серверов, конфигураций и пайплайнов, чтобы всё работало стабильно.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card-shell card-dev">
    <div class="card-inner">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">
          Разбираю исходный код на уязвимости, секреты в git-истории и слабые места в логике. Помогаю исправить найденное.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="card-shell card-access">
    <div class="card-inner">
      ...
      <div class="card-body">
        ...
        <p class="card-desc">
          Проверяю, не утекли ли конфиденциальные данные в интернет: в дампах, публичных архивах, OSINT и других источниках.
        </p>
      </div>
    </div>
  </div>
  ...
  <!-- ══════════════════════════════════════════════════════════════════════
	     CARD 6 — Консультация (full-width)
	     ══════════════════════════════════════════════════════════════════════ -->
